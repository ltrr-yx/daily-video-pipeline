...
VISUAL_THEMES: dict[str, dict[str, Any]] = {
    "editorial_dark": {
        ...
        "style": {
            ...
            "font_en": "Georgia / New York",
            "font_stack": "Noto Serif SC, Source Han Serif SC, Georgia, serif",
            "type_scale": "Headline 72 / Body 39 / Label 24",
            "headline_size": 72,
            "body_size": 40,
            "label_size": 24,
            "text_ratio": 64,
            "media_ratio": 36,
            "color_strategy": "Dark restrained: ink field, warm proof accent, teal source status.",
    ...
    "executive_light": {
        ...
        "style": {
            ...
            "font_en": "SF Pro / Helvetica Neue",
            "font_stack": "SF Pro Display, Helvetica Neue, Noto Sans SC, Source Han Sans SC, system-ui, sans-serif",
            "type_scale": "Headline 66 / Body 38 / Label 24",
            "headline_size": 66,
            "body_size": 37,
            "label_size": 24,
            "text_ratio": 56,
            "media_ratio": 44,
            "color_strategy": "Restrained: cool neutral surface, blue actions, ochre confirmation.",
    ...
    "market_terminal": {
        ...
        "style": {
            ...
            "font_en": "SF Mono / Menlo",
            "font_stack": "SFMono-Regular, Menlo, Noto Sans Mono CJK SC, monospace",
    ...
    "product_keynote": {
        ...
        "style": {
            ...
            "font_en": "SF Pro / Helvetica Neue",
            "font_stack": "SF Pro Display, Helvetica Neue, Noto Sans SC, HarmonyOS Sans SC, system-ui, sans-serif",
            ...
            "text_ratio": 50,
            "media_ratio": 50,
            "color_strategy": "Restrained product: cool neutral base, teal status, violet timing accent.",
            ...
            "card_radius": 10,
            "card_surface_mix": 0.48,
            "top_rule_height": 7,
            "ornament": "Teal status chips, violet timing rails, and quiet review marks.",
            "underline": "Short violet timing rule only when the feature name needs emphasis.",
        },
    },
    "data_magazine": {
        "name": "Data Magazine",
        ...
        "style": {
            "font_zh": "Noto Serif SC / Source Han Serif SC",
            "font_en": "Georgia / Source Serif",
            "font_stack": "Georgia, Noto Serif SC, Source Han Serif SC, serif",
            "type_scale": "Headline 70 / Body 38 / Label 23",
            "headline_size": 70,
            "body_size": 37,
            "label_size": 23,
            "text_ratio": 58,
            "media_ratio": 42,
            "color_strategy": "Neutral data page with teal evidence and rust editorial emphasis.",
            "contrast": "Ink-forward copy, restrained warm accent, no beige page wash.",
            "density": "Measured editorial, chart-forward, slower read.",
            "card_radius": 8,
            "card_surface_mix": 0.44,
            "top_rule_height": 5,
    ...
    "social_pop": {
        ...
        "style": {
            ...
            "font_en": "Arial Black / Helvetica Neue",
            "font_stack": "Arial Black, Helvetica Neue, Noto Sans SC, Source Han Sans SC, system-ui, sans-serif",
            "type_scale": "Headline 78 / Body 40 / Label 25",
            "headline_size": 78,
            "body_size": 40,
            "label_size": 26,
            "text_ratio": 50,
            "media_ratio": 50,
            "color_strategy": "Full palette: dark violet base, yellow hook, cyan motion, pink risk.",
